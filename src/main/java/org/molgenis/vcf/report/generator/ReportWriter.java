...
public class ReportWriter {
  ...
  private void writeCheckedException(Report report, Path outputFile,
    ...
    if (templatePath == null) {
      templatePath = ResourceUtils.getFile("classpath:template-default.html").toPath();
    }

    String templateHtml = Files.readString(templatePath, UTF_8);
