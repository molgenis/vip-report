...
public class NestedRepository {
    ...
    private static void insertNestedValue(int index, List<String> matchingNestedFields, String nestedStringValue, String parent, FieldMetadata parentMeta, PreparedStatement insertNestedStmt, Map<FieldValueKey, Integer> categoryLookup, boolean hasDecisionTree) throws SQLException {
