...
public class CategoryUtils {
    ...
    public static void addCategorical(FieldType type, FieldMetadata meta, Map<FieldValueKey, Integer> categoryLookup, String field, Object val, PreparedStatement insertNestedStmt, int index) throws SQLException {
        addCategorical(type, meta, categoryLookup, field, null, val, insertNestedStmt, index);
    }

    public static void addCategorical(FieldType type, FieldMetadata meta, Map<FieldValueKey, Integer> categoryLookup, String field, String parent, Object val, PreparedStatement insertNestedStmt, int index) throws SQLException {
