...
class DatabaseSchemaManagerTest {
    ...
    private static final String EXPECTED_FORMAT_TABLE = "CREATE TABLE format (id INTEGER PRIMARY KEY AUTOINCREMENT,sampleIndex INTEGER REFERENCES sample(sampleIndex),variantId INTEGER REFERENCES vcf(id),HQ TEXT,GQ INTEGER,DP INTEGER,GT TEXT,GtType INTEGER REFERENCES gtType(id));";
}
