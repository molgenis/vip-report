...
class DatabaseSchemaManagerTest {
    ...
    private static final String NESTED_TABLE_SQL = "CREATE TABLE info (_id INTEGER PRIMARY KEY AUTOINCREMENT,_variantId INTEGER REFERENCES vcf(_id),AA TEXT,NS INTEGER,AF TEXT,H2 TEXT,DP INTEGER,DB TEXT) STRICT;";
